...
export default function Home() {
  return (
    <main
      className="flex flex-col bg-main-bg text-og min-h-screen items-center"
    >
      ...
      <div className="flex flex-auto flex-col items-center font-extrabold tracing-[0.03125rem] h-[28.9rem] text-[12.0625rem]">
        <span className="leading-[10.375rem]  text-center -z-20">CASH <br/> <span className="-z-0"> APP</span></span>
